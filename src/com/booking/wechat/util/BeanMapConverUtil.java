...
public class BeanMapConverUtil {
     ...
     */
    public static <T> Map<String, Object> beanAndSuperToMap(T bean) {
    ...
    public static <T> void setProperties(T entity, String propertyName, Object value) throws IntrospectionException,
