...
<form method="post" action="<%=basePath %>system/faqs/insert?navTabId=faqNavTab&callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
    <div class="pageFormContent" layoutH="57">
    <fieldset>
        <legend>添加自动回复信息</legend>
        ...
        <dl>
            <dt>问题编号: </dt>
            <dd><input class="digits" type="text" id="faqNumber" name="faqNumber"></dd>
        </dl>
        <dl id="faqTypeTxt">
            <dt>问题分类: </dt>
            <dd><input type="text" id="faqType" name="faqType"></dd>
        </dl>
        <dl id="faqTitleTxt" style="display: none">
            <dt>问题标题: </dt>
            <dd><input type="text" id="faqTitle" name="faqTitle"></dd>
        </dl>
        <dl id="faqContextTxt" style="display: none"  class="nowrap">
            <dt>问题内容: </dt>
            <dd><textarea cols="80" rows="2" id="faqContext" name="faqContext"></textarea></dd>
        </dl>
